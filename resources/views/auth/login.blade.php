...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Login | YRATMED - Admin & Dashboard Template</title>
                                ...
                                <div class="row">
                                    <div class="col-7">
                                        <div class="text-primary p-4">
                                            ...
                                            <p>Sign in to continue to YRATMED.</p>
                                        </div>
                                    </div>
                            ...
                            <div class="card-body pt-0"> 
                                ...
                                <div class="p-2">
                                    <form method="POST" action="{{ route('login') }}">
                                        ...
                                        <div class="mt-3 d-grid">
                                            <a href="{{ route('register') }}" class="waves-effect waves-light" type="submit">Register</a>
                                        </div>                                            
                                    </form>
                                </div>
