...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            <h4 class="mb-sm-0 font-size-18">Plan Check Update</h4>
    ...
    <div class="col-xl-12">
        <div class="card">
            <div class="card-body">   
                ...
                @endif    
                <form class="custom-validation" action="{{ route('plan-check.store') }}" method="POST" enctype="multipart/form-data" validate>
                    @csrf   
                <div class="row">  
                    <div class="col-3">
                    ...
                    <div class="col-3">
                        ...
                        <input type="hidden" name="plan_sub" value="Check">
                    </div> 
                    <div class="col-3">
