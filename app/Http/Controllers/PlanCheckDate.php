...
class PlanCheckDate extends Controller
{
    ...
    {
        $plan = DB::table('plan_data_lists')->where('flag',true)->where('status_id',2)->get();
        return view('plan.plan-check-list',compact('plan'));
    }
    ...
    public function edit($id)
    {
        ...
        ->first();
        $sub = DB::table('plan_sub_lists')->where('plan_id',$id)->get();
        return view('plan.plan-check-update',compact('plan','sub'));
    }
